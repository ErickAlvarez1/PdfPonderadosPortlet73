...
<div class="rowRecomendacion">
	<div class="row mt-5">
		<div class="col-md-12 mt-5">
			<p class="font-weight-bold h3-responsive text-center">RECOMENDACIONES</p>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-1">
			<p class="font-weight-bold h3-responsive text-center"><a id="addRecomendacion"><i class="fas fa-plus"></i></a></p>
		</div>
	</div>
...
<!-- 			<p class="font-weight-bold h3-responsive text-center temaRecomenda">Recomendaciones (No mostró evidencia)</p> -->
			<p class="font-weight-bold h3-responsive text-center temaRecomenda">${temaDinamico}</p>
			<p class="font-weight-bold h5-responsive text-center pregRecomenda">${preguntaDinacimo }</p>
		</div>
		<div class="col-md-12">
